...
class VehicleColorAdapter(val context: Context, var vehicleModelsList: ArrayList<VehicleColorsData>) : BaseAdapter() {
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
        ...
        vh.label.text = vehicleModelsList.get(position).color
        return view
    }
