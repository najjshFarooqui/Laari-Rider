...
class VehicleMakersAdapter(val context: Context, var vehicleModelsList: ArrayList<VehicleMakersData>) : BaseAdapter() {
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
        ...
        vh.label.text = vehicleModelsList.get(position)!!.makersName
        return view
    }
