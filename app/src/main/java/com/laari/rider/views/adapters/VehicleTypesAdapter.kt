...
class VehicleTypesAdapter(val context: Context, var vehicleModelsList: ArrayList<VehicleTypeSData>) : BaseAdapter() {
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
        ...
        vh.label.text = vehicleModelsList.get(position)!!.typeName
        return view
    }
